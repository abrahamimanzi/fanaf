    ...
    if($participant_data->payment_state == "Confirmed"){
        ...
        class PDF extends FPDF{
            ...
            function Header()
            {
                ...
                $this->Cell(0,95,' fanaf2018.com',0,0,'R');
...
// Instanciation of inherited class
        ...
        // $pdf->Cell(0,0,'The events factory is collecting registration fee on behalf of ',0,0,'C');
        $pdf->Cell(0,0,'The events factory est la collecte des frais d\'inscription au nom de ',0,0,'C');

        $pdf->SetY(550); 
        $pdf->SetFont('Arial','',14);
        $pdf->Cell(0,0,'42eme Assemblee Generale Annuelle de la FANAF',0,0,'C');

        $pdf->SetY(570); 
        $pdf->SetFont('Arial','',14);
        // $pdf->Cell(0,0,'Any query please contact us on',0,0,'C');
        $pdf->Cell(0,0,'Toute requete s\'il vous plait nous contacter sur',0,0,'C');
