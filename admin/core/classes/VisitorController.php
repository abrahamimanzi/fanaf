            ...
            if($diagnoArray[0] == 'NO_ERRORS'){
                ...
                try{
                    ...
                    if($participantTable->count() && $participantTable->first()->email == $email){
                        ...
                        // including students, academics, '.EVENT.' related incubation hub tenants 
                        // amongst others. <br>Passes are given at the organizers discretion and 
                        // are dependent on availability.';

                        $messageText_2= 'For the complete <a href="'.DN.'/visit/#Exhibitorlist">exhibitor list</a> 
                        and more information about <a href="'.DN.'/visit/#Travel">Travel & Stay</a>, 
                        please visit our <a href="'.DN.'/visit/">website</a>.';
