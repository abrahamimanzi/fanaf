            ...
            if($diagnoArray[0] == 'NO_ERRORS'){
                ...
                try{
                    ...
                    if($participantTable->count() && $participantTable->first()->email == $email){
                        ...
                        $subject= 'Inscription pour l\'exposition au 42eme Assembee Generale Annuelle de la FANAF / Registration for the 42eme Assemblee Generale Annuelle de la FANAF Exhibition';

                        $messageText_0= 'Cher <b>'.$participant_data->firstname.' '.$participant_data->lastname.' '.$participant_data->othername.'</b>,';

                        $messageText_1= 'Merci d\'avoir manifesté votre intérêt à exposer au '.EVENT.' (Kigali, Rwanda).';

                        $messageText_2= 'Votre inscription a été approuvée, Vous recevrez une facture cumulée, selon la commande que vous avez passée, sous peu';

                        $messageText_3 = '<br><br>---------------------------------------------<br><br>';

                        $messageText_4= 'Dear <b>'.$participant_data->firstname.' '.$participant_data->lastname.' '.$participant_data->othername.'</b>,';

                        $messageText_5= 'Thank you for expressing your interest in exhibiting at the '.EVENT.' (Kigali, Rwanda).';

                        $messageText_6= 'Your Registration has been approved, 
                        You will receive a cumulated invoice, according to the order you placed, shortly';
                                ...
                                <div style="padding: 10px; margin-left: 10px margin-right: 10px">
                                    ...
                                    <div style="font-size: 13px; padding: 0px; position: relative">
                                        <div style="text-align: left; border-top: 1px solid #ddd; padding: 10px 5px">
                                            Cordialement / Kind regards,<br><br>
