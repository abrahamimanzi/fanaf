...
//                            $reference_number = $code_string_0.'-'.Dates::get('Ymdhis');
                        ...
                        $subject= 'Merci pour votre soumission d\'inscription pour 42eme Assembee Generale Annuelle de la FANAF / Thank you for your registration submission for 42eme Assembee Generale Annuelle de la FANAF';

                        $messageText_0= 'Cher <b>'.$participant_data->firstname.' '.$participant_data->lastname.' '.$participant_data->othername.'</b>,';

                        $messageText_1= 'Merci pour votre demande d\'inscription pour '.EVENT.' (Kigali, Rwanda).';

                        $messageText_2= 'Nous passerons en revue votre inscription et vous répondrons dans les plus brefs délais';
                        ...
                        $messageText_5= 'Thank you for your registration request for '.EVENT.' (Kigali, Rwanda).';

                        $messageText_6= 'We will review your registration and get back to you shortly';
