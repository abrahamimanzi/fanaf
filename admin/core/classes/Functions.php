	...
	public static function smartMailer($contactDetails,$subject,$message_body,$message_alt){
        ...
        try {
            ...
            if($_SERVER['HTTP_HOST'] != 'localhost' && $_SERVER['HTTP_HOST'] != '127.0.0.1'){
                ...
                $mail->Username = "fanafagm@gmail.com";
	...
	public static function getJobTitles($errorstate,$value='',$categ){
        ...
        if($categ == "Media"){
           ...
           ?>
            ...
            <option value="Chairman / Executive Chairman" <?php if($errorstate && $value == 'Chairman / Executive Chairman'){ echo 'selected="selected"';}?>>Président / Président exécutif / Chairman / Executive Chairman</option>

            <option value="Chief Executive Officer (CEO)" <?php if($errorstate && $value == 'Chief Executive Officer (CEO)'){ echo 'selected="selected"';}?>>Président Directeur-Général (PDG) / Chief Executive Officer (CEO)</option>

            <option value="Chief Financial Officer (CFO)" <?php if($errorstate && $value == 'Chief Financial Officer (CFO)'){ echo 'selected="selected"';}?>>Directeur Financier (CFO) / Chief Financial Officer (CFO)</option>
            ...
            <option value="Chief Marketing Officer (CMO)" <?php if($errorstate && $value == 'Chief Marketing Officer (CMO)'){ echo 'selected="selected"';}?>>Directeur Marketing (CMO) / Chief Marketing Officer (CMO)</option>

            <!-- <option value="Chief of Staff" <?php if($errorstate && $value == 'Chief of Staff'){ echo 'selected="selected"';}?>>Chief of Staff</option> -->
            
            <option value="Chief Operating Officer (COO)" <?php if($errorstate && $value == 'Chief Operating Officer (COO)'){ echo 'selected="selected"';}?>>Chef de l'exploitation / Chief Operating Officer (COO)</option>
            ...
            <option value="Deputy CEO" <?php if($errorstate && $value == 'Deputy CEO'){ echo 'selected="selected"';}?>>L'adjoint au PDG / Deputy CEO</option>
            ...
            <option value="Executive Director" <?php if($errorstate && $value == 'Executive Director'){ echo 'selected="selected"';}?>>Directeur exécutif / Executive Director</option>
            ...
            <option value="Executive Secretary" <?php if($errorstate && $value == 'Executive Secretary'){ echo 'selected="selected"';}?>>Secrétaire exécutif / Executive Secretary</option>
            ...
            <option value="Managing Director" <?php if($errorstate && $value == 'Managing Director'){ echo 'selected="selected"';}?>>Directeur général / Managing Director</option>
            ...
            <option value="Secretary General" <?php if($errorstate && $value == 'Secretary General'){ echo 'selected="selected"';}?>>Secrétaire général / Secretary General</option>
            ...
            <option value="Student" <?php if($errorstate && $value == 'Student'){ echo 'selected="selected"';}?>>Étudiant / Student</option>
        ...
        ?>
            <option value="Other" <?php if($errorstate && $value == 'Other'){ echo 'selected="selected"';}?>>Autre / Other </option>
        <?php
	}
