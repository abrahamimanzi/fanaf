...
//                            $reference_number = $code_string_0.'-'.Dates::get('Ymdhis');
                        ...
                        $subject= 'Merci de manifester votre interet a prendre la parole au 42eme Assembee Generale Annuelle de la FANAF / Thank you for your interest to speak at the 42eme Assembee Generale Annuelle de la FANAF';

                        $messageText_0= 'Cher <b>'.$participant_data->firstname.' '.$participant_data->lastname.'</b>,';

                        $messageText_1= 'Merci d\'avoir exprimé votre intérêt à prendre la parole au '.EVENT.' (Kigali, Rwanda).';

                        $messageText_2= 'Notre équipe sera en contact avec vous sous peu.';

                        $messageText_3= '<br><br>----------------------------<br><br>';


                        $messageText_4= 'Dear <b>'.$participant_data->firstname.' '.$participant_data->lastname.'</b>,';

                        $messageText_5= 'Thank you for expressing your interest in speaking at the '.EVENT.' (Kigali, Rwanda).';

                        $messageText_6= 'Our team will be in touch with you shortly.';
                ...
                <div style="padding: 10px; margin-left: 10px margin-right: 10px">
                    ...
                    <section>
                        ...
                        <p style="font-size: 13px;">
                            ...
                            You will be able to purchase pre-paid travel cards giving 
                            you access to the entire '.EVENT.' bus network during your stay in Kigali.
                        </p>
                        <p style="font-size: 13px;">
                            <b>Car hire:</b><br>
                            Should you wish to hire a car during your stay in Kigali, 
                            click here [Click here to plan your trip]
                        </p>
                        '.@$messageText_3.'
                        <p style="font-size: 13px;">
                            <b>Stay connected</b> <br>
