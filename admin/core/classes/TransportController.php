                    ...
                    */
                    ...
                    if($accommadationTable->count() && $accommadationTable->first()->email == $email){
                        ...
                        */
                        ...
                        $subject = 'Demande de reservation de voiture pour le 42eme Assemblee Generale Annuelle de la FANAF'
                        ...
                        $messageText_1= 'Merci d\'avoir soumis votre demande de reservation de voiture pour le 42eme Assemblee Generale Annuelle de la FANAF au Kigali, Rwanda.';
                        ...
                        $messageText_2= 'Notre equipe vous reviendra sous peu avec la disponibilite et les tarifs tout en vous mettant directement en contact avec l\'equipe de reservation de voiture.';

                        // $messageText_3= 'Please note that all payments are to be made to the car directly.';
                        $messageText_3= 'Veuillez noter que tous les paiements doivent etre effectues directement a la voiture.';
                        ...
                        $messageText_7= 'Thank you for submitting your car reservation query for the '.EVENT.' in Kigali, Rwanda.';

                        $messageText_8= 'Our team will revert to you shortly with availability and rates whilst also putting you in touch with the car reservation team directly.';

                        $messageText_9= 'Please note that all payments are to be made to the car directly.';
                                ...
                                <div style="padding: 10px; margin-left: 10px margin-right: 10px">
                                    ...
                                    <div style="font-size: 13px; padding: 0px; position: relative">
                                        <div style="text-align: left; border-top: 1px solid #ddd; padding: 10px 5px">
                                            Sinceres amities / Kind regards,<br><br>
                        ...
                        $messageText_1= 'We have a new reservation application for the '.$accommadation_data->car.': . Below are the applicants details.';
