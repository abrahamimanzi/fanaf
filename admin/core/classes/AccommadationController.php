...
class AccommadationController  
{
	public static function add($form='Admin'){
        ...
        if($validation->passed()){
            ...
            $room_name = $str->data_in(@$_SUBMIT['room']);
            $price = $str->data_in(@$_SUBMIT['price']);
            $room_ID = $str->data_in(@$_SUBMIT['room_ID']);
                    ...
                    */
                    ...
                    if($accommadationTable->count() && $accommadationTable->first()->email == $email){
                        ...
                        */
                        ...
                        $subject = 'Demande de reservation d\'hotel pour 42eme Assemblee Generale Annuelle de la FANAF';

                        // $messageText_0= 'Dear <b>'.$accommadation_data->firstname.' '.$accommadation_data->lastname.'</b>,';
                        $messageText_0= 'Cher <b>'.$accommadation_data->firstname.' '.$accommadation_data->lastname.'</b>,';

                        // $messageText_1= 'Thank you for submitting your hotel reservation query for the '.EVENT.' in Kigali, Rwanda.';
                        $messageText_1= 'Merci d\'avoir soumis votre demande de reservation d\'hotel pour le 42eme Assemblee Generale Annuelle de la FANAF au Kigali, Rwanda.';
                        ...
                        $messageText_2= 'Notre equipe vous reviendra sous peu avec la disponibilite et les tarifs tout en vous mettant directement en relation avec l\'equipe de reservation des hotels.';

                        // $messageText_3= 'Please note that all payments are to be made to the hotel directly.';
                        $messageText_3= 'Veuillez noter que tous les paiements doivent etre effectues directement a l\'hotel.';

                        // $messageText_4= 'Do not hesitate to contact us if you require any further information.';
                        $messageText_4= 'N\'hesitez pas a nous contacter si vous avez besoin de plus d\'informations.';

                        $messageText_5= '--------------------------------------------';

                        $messageText_6= 'Dear <b>'.$accommadation_data->firstname.' '.$accommadation_data->lastname.'</b>,';

                        $messageText_7= 'Thank you for submitting your hotel reservation query for the 42eme Assemblee Generale Annuelle de la FANAF in Kigali, Rwanda.';

                        $messageText_8= 'Our team will revert to you shortly with availability and rates whilst also putting you in touch with the hotels reservation team directly.';

                        $messageText_9= 'Please note that all payments are to be made to the hotel directly.';

                        $messageText_10= 'Do not hesitate to contact us if you require any further information.';
                                ...
                                <div style="padding: 10px; margin-left: 10px margin-right: 10px">
                                    ...
                                    <div style="font-size: 13px; padding: 0px; position: relative">
                                        <div style="text-align: left; border-top: 1px solid #ddd; padding: 10px 5px">
                                            Sincères amitiés / Kind regards,<br><br>
                        ...
                        Redirect::to(DN.'/accommondationpayment/'.$accommadation_ID);
