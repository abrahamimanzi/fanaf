...
{   
	public static function add($form='Admin'){
        ...
        if ($category=='Silver' OR $category=='silver' OR $category=='Individual-Silver') {
            ...
            $pass_type='Gold';
        }elseif($category=='Nonmember' OR $category=='nonmember' OR $category=='Nonmember'){
            $category='Nonmember';
            $pass_type='Nonmember';
        }elseif($category=='Local' OR $category=='local' OR $category=='Local'){
            $category='Local';
            $pass_type='Local';
        ...
        if($validation->passed()){
            ...
            $checkinhour= $str->data_in(@$_SUBMIT['checkinhour']);

            $checkout= $str->data_in(@$_SUBMIT['checkout']);

            $checkouthour= $str->data_in(@$_SUBMIT['checkouthour']);
            ...
            if($diagnoArray[0] == 'NO_ERRORS'){
                ...
                try{
                    ...
                    if($participantTable->count() && $participantTable->first()->email == $email){
                        ...
                        $subject= '42eme Assemblee Generale de la FANAF 2018 enregistrement';

                        $messageText_0= 'Cher <b>'.$participant_data->firstname.' '.$participant_data->lastname.' '.$participant_data->othername.'</b>,';

                        $messageText_1= 'Merci de vous etre enregistre pour 42eme Assemblee Generale de la FANAF 2018.';

                        if($subscateg_data->plan!='Free'){

                            $messageText_2= '<b>Paiement par carte de credit ou carte de debit</b>';

                            $messageText_3= 'Si vous avez effectue votre paiement avec succes par 
                            carte de debit ou de credit, vous recevrez un courriel avec un recu.';

                            $messageText_4= 'Si vous n\'avez pas effectue votre paiement par carte 
                            de debit ou de credit, veuillez noter que votre inscription ne sera pas 
                            traitee tant que le paiement n\'aura pas ete recu. Vous pouvez completer 
                            votre paiement par carte ou carte de debit 
                            par<a href="'.DN.'/payment/'.$participant_code.'">cliquant ici</a>.';

                            $messageText_5='<b>Paiement par virement bancaire ou depot direct</b>';

                            $messageText_6='Votre facture pour le paiement vous sera envoyee 
                            momentanement pour traiter votre paiement par virement bancaire 
                            ou depot direct.';

                            $messageText_7= 'S\'il vous plait contactez-nous via '.EMAIL1.', 
                            si vous n\'avez pas recu votre facture dans les 48 heures.';

                            $messageText_8= 'Vous serez informe lorsque nous recevrons votre 
                            paiement par virement bancaire ou depot direct.';

                            $messageText_9= 'Veuillez vous assurer que vous suivez les 
                            instructions sur la facture pour vous assurer que votre paiement 
                            est suivi et crédité à votre inscription.';

                            $messageText_10= 'Veuillez noter que votre inscription ne sera 
                            pas complete tant que le paiement integral de votre carte de 
                            delegue n\'aura pas ete recu.';
                        ...
                        $messageText_12= 'Vous recevrez votre confirmation pour participer 
                        au sommet par email (qui sera complet des reception du paiement)';

                        $messageText_13= 'Veuillez nous envoyer un courriel sur '.EMAIL1.' 
                        si vous n\'avez pas recu votre confirmation durant cette periode.';

                        $messageText_14= '<b>Collecte de votre badge</b>';

                        $messageText_15= 'Le centre d\'accreditation est situe sur the 
                        Kigali Convention Center, jour avant le sommet.';

                        $messageText_16= 'Veuillez noter que votre badge ne sera emis qu\'une 
                        fois que vous aurez recu votre confirmation pour assister au sommet.';

                        $messageText_17= '--------------------------------------';

                        $messageText_18= 'Dear <b>'.$participant_data->firstname.' '.$participant_data->lastname.' '.$participant_data->othername.'</b>,';

                        $messageText_19= 'Thank you for registering for '.EVENT.'.';

                        //

                        if($subscateg_data->plan!='Free'){

                            $messageText_20= '<b>Payment by Credit card or Debit card</b>';

                            $messageText_21= 'If you have successfully completed your payment by debit or credit card, you will 
                            receive an email with a receipt.';

                            $messageText_22= 'If you have not completed your payment by debit or credit card, kindly note that 
                            ...
                            $messageText_23='<b>Payment by Bank Transfer or Direct Deposit</b>';

                            $messageText_24='Your invoice for payment will be sent to you momentarily to process your payment 
                            by bank transfer or direct deposit.';

                            $messageText_25= 'Please contact us via '.EMAIL1.', if you have not received your invoice within 48 hours.';

                            $messageText_26= 'You will be notified when we receive your payment via bank transfer or direct deposit.';

                            $messageText_27= 'Please ensure that you follow the instructions on the invoice to ensure your 
                            payment is tracked and credited to your registration.';

                            $messageText_28= 'Kindly note that your registration will be not be complete until full payment for your 
                        ...
                        $messageText_29= '<b>Confirmation</b>';
                        ...
                        $messageText_30= 'You will receive your confirmation to attend the summit via email (which will be complete upon receipt of payment)';

                        $messageText_31= 'Kindly email us on '.EMAIL1.' if you have not received your 
                        confirmation within this period.';

                        $messageText_32= '<b>Collecting your badge</b>';

                        $messageText_33= 'The accreditation center is located on the Kigali Convention Center, day before summit.';
                        ...
                        $messageText_34= 'Please note that your badge will only be issued once you have received your confirmation to attend the summit.';
                                ...
                                <div style="padding: 10px; margin-left: 10px margin-right: 10px">
                                    ...
                                    <div style="font-size: 13px; padding: 0px; position: relative">
                                        <div style="text-align: left; border-top: 1px solid #ddd; padding: 10px 5px">
                                            ...
                                            42eme Assemblee Generale de la FANAF 2018 Team<br>
                                            E:  '.EMAIL1.'<br>
                                            T:  '.PHONE1.'<br>
                                            + '.PHONE2.'<br>
    ...
    public static function paymentConfirmedEmail($participant_data){
        ...
        if($participant_data->state != "Confirmed"){
            ...
            $messageText_1= 'Thank you for registration for '.EVENT.' summit, The '.EVENT.' in Kigali Rwanda.<br><br>Your payment has been successfully processed.';
        }
