...
function def(){	
	...
	define("P",".php");
	define("PL",".php");
	define("EVENT","42ème Assemblée Générale Annuelle de la FANAF");
	define("EVENT_SHORT","F17");
	define("PHONE1","+250 784 273 311");
	define("PHONE2","+250 788 358 188");
	define("EMAIL1","fanaf2018@theeventsfactory.biz");
	define("ACCRE_EMAIL", "fanaf2018@theeventsfactory.biz");
	
	define("TRANSPORT_EMAIL", "fanaf2018@theeventsfactory.biz");
	
	define("TWITTER","fanaf");
	define("TAG","#fanaf");
	define("FB","fanaf");
	define("YOUTUBE","fanaf");
	define("EVENT_WEB","theeventsfactory.biz/fanaf/register");
...
$GLOBALS['config'] = array(
	...
	'url' => array(
		'app_dir'=>"",
		'home' => "$http://{$_SERVER['HTTP_HOST']}/fanaf",
//		'home' => "$http://{$_SERVER['HTTP_HOST']}/fanaf_test",
