...
//		break;
        ...
        // Hotel //
        case 'hotel-new':
            // if(Input::checkInput('hotel-new','post','1')){
                // echo "string";
                $participantCategTable = new Hotels();
                $form = HotelsController::add();
                if($form->ERRORS == false){ 
                    // Redirect::to(DNADMIN.'/accommodation/hotel/new');
                }else{
                    // echo errors;
                }
            // }
        ...
        case 'room-new':
            // if(Input::checkInput('hotel-new','post','1')){
                ...
                $form = RoomsController::add();
                if($form->ERRORS == false){ 
                    Redirect::to(DNADMIN.'/accommodation/5/room/new');
                }else{
                    // echo errors;
                }
            // }
