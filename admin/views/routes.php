                ...
                if(Input::get('id','get')){
                    ...
                    if($event_select->count()){  // Event found and registered by this compay, then Display details
                        ...
                        switch($url_struc['branch']){
                            ...
                            break;
                            case 'hotels':
                                include 'views/accommodation/hotels'.PL;
                            break;
                        }
                    }
                }
                ...
                switch($url_struc['trunk']){
                    case 'hotel':
                        switch($url_struc['branch']){    
                            ...
                            break;
                            case 'new':
                                include 'views/accommodation/new-hotel'.PL;
                            break; 
                            case 'edit':
                                $user_ID = Input::get('id','get');
                                $userTable = new User();
                    ...
                    case 'room':
                        switch($url_struc['branch']){    
                            ...
                            break;
                            case 'view':
                                include 'views/accommodation/rooms'.PL;
                            break; 
                            case 'new':
                                include 'views/accommodation/new-room'.PL;
                            break; 
                            case 'edit':
                                $user_ID = Input::get('id','get');
                                $userTable = new User();
