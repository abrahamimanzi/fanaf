...
<body class="home page page-id-2">
  ...
  <div class="sectiongrey">
      <section>
          <div class="separator"> 
              <div class="line"></div>
              <h2>HÉBERGEMENT / ACCOMMODATION</h2>
              <div class="line"></div>
          </div>
          <div class="grid2">
            ...
            <div class="container " style="width:100%; padding: 0px;">
                <div class="text-">
                    ...
                    <p>
                      Les délégués auront accès à des tarifs préférentiels <strong>(petit-déjeuner inclus)</strong> 
                      dans les hôtels partenaires suivants. Ces tarifs sont en vigueur jusqu'au 11 janvier 2018, 
                      après cette date, la réservation sera soumise à disponibilité et les tarifs pourraient changer.

                      Nous vous encourageons à réserver votre hébergement en utilisant à la fois votre numéro 
                      d'enregistrement et le code promotionnel que vous obtenez à la fin du processus d'inscription.
                    <!-- <a href="'.DN.'/accomodation" class="btn btn-platinum">Book Accomodation</a> -->
                    </p>
                    <p>
                      Delegates will have access to preferential rates <strong>(breakfast inclusive)</strong> 
                      at following partners Hotels.These rates are effective until the 11th January 2018, 
                      after the said date, reservation will be subject to Availability and Rates might change.   

                      You are encouraged to book your accommodation using both your registration number 
                      and the Promo Code that you get upon completion of the registration process.
                    <!-- <a href="'.DN.'/accomodation" class="btn btn-platinum">Book Accomodation</a> -->
                    </p>
                    ...
                    <div class="clearfix" style="margin: 2%;"></div> 
                      ...
                      <h2 style="width:100%;color:#000;"><small>HOTELS PARTENAIRES</small></h2>
                      <p>Les délégués qui resident dans les hotel partenaire, bénéficieront d'un tarif négocié 
                      et de moyen de transport (hotel-conference-aéroport) en accordance avec le Programme de 
                      la Conference.</p>
                      <div class="panels">
                        <div class="row" style="margin-right: 2%">
                          ...
                          <div class="col-xs-10 col-xs-offset-1 col-sm-3 col-sm-offset-0">
                            <div class="panel panel-gold text-center bg-hotel">
                              <!-- <a href="#" target="_blank" title="Raddison Blu Hotel"> -->
                              <!-- <a href="https://www.radissonblu.com/en/hotel-kigali" target="_blank" title="Raddison Blu Hotel"> -->
                              <a href="<?=DN?>/register/accommodation/raddison" target="_blank" title="Raddison Blu Hotel">
                                ...
                                <div class="panel-body" style="padding: 10px 5px;">
                                  ...
                                  <small class="small">Distance jusqu'au lieu de la conference: <strong>1 minutes</strong> </small><br><hr class="hr-packs-gold"> 
                          ...
                          <div class="col-xs-10 col-xs-offset-1 col-sm-3 col-sm-offset-0">
                            <div class="panel panel-gold text-center bg-hotel">
                              <!-- <a href="#" target="_blank" title="Kigali Serena Hotel"> -->
                              <!-- <a href="http://www.serenahotels.com/serenakigali/default-en.html" target="_blank" title="Kigali Serena Hotel"> -->
                              <a href="<?=DN?>/register/accommodation/serena" target="_blank" title="Kigali Serena Hotel">
                                ...
                                <div class="panel-body" style="padding: 10px 5px;">
                                  ...
                                  <hr class="hr-packs-plat"> 
                                  <small class="small">Distance jusqu'au lieu de la conference: <strong>15 minutes</strong> </small><br><hr class="hr-packs-gold"> 
                          ...
                          <div class="col-xs-10 col-xs-offset-1 col-sm-3 col-sm-offset-0">
                            <div class="panel panel-gold text-center bg-hotel">
                              <!-- <a href="#" target="_blank" title="MARRIOT HOTEL KIGALI"> -->
                              <!-- <a href="http://www.marriott.com/hotels/travel/kglmc-kigali-marriott-hotel/" target="_blank" title="MARRIOT HOTEL KIGALI"> -->
                              <a href="<?=DN?>/register/accommodation/marriot" target="_blank" title="MARRIOT HOTEL KIGALI">
                                ...
                                <div class="panel-body" style="padding: 10px 5px;">
                                  ...
                                  <hr class="hr-packs-plat"> 
                                  <small class="small">Distance jusqu'au lieu de la conference: <strong>14 minutes</strong> </small><br><hr class="hr-packs-gold"> 
                          ...
                          <div class="col-xs-10 col-xs-offset-1 col-sm-3 col-sm-offset-0">
                            <div class="panel panel-gold text-center bg-hotel">
                              <!-- <a href="#" target="_blank" title="Hotel Des Mille Collines"> -->
                              <!-- <a href="https://www.millecollines.rw" target="_blank" title="Hotel Des Mille Collines"> -->
                              <a href="<?=DN?>/register/accommodation/collines" target="_blank" title="Hotel Des Mille Collines">
                        ...
                        <div class="row" style="margin-right: 2%">
                          <div class="col-xs-10 col-xs-offset-1 col-sm-3 col-sm-offset-0">
                            <div class="panel panel-gold text-center bg-hotel">
                              ...
                              <!-- <a href="#" target="_blank" title="Ubumwe Grand Hotel"> -->
                              <a href="<?=DN?>/register/accommodation/ubumwe" target="_blank" title="Ubumwe Grand Hotel">
                                ...
                                <div class="panel-body" style="padding: 10px 5px;">
                                  ...
                                  <hr class="hr-packs-plat"> 
                                  <small class="small">Distance jusqu'au lieu de la conference: <strong>13 minutes</strong> </small><br><hr class="hr-packs-gold"> 
                          ...
                          <div class="col-xs-10 col-xs-offset-1 col-sm-3 col-sm-offset-0">
                            <div class="panel panel-gold text-center bg-hotel">
                              <!-- <a href="https://www.tripadvisor.co.uk/Hotel_Review-g293829-d8387529-Reviews-Hotel_Hilltop_Country_Club-Kigali_Kigali_Province.html" target="_blank" title="HILL VIEW APARTMENTS"> -->
                              <!-- <a href="#" target="_blank" title="HILL VIEW APARTMENTS"> -->
                              <a href="<?=DN?>/register/accommodation/hillview" target="_blank" title="HILL TOP HOTEL">
                                ...
                                <div class="panel-body" style="padding: 10px 5px;">
                                  ...
                                  <hr class="hr-packs-plat"> 
                                  <small class="small">Distance jusqu'au lieu de la conference: <strong>10 minutes</strong> </small><br><hr class="hr-packs-gold"> 
                          ...
                          <div class="col-xs-10 col-xs-offset-1 col-sm-3 col-sm-offset-0">
                            <div class="panel panel-gold text-center bg-hotel">
                              ...
                              <!-- <a href="#" target="_blank" title="GALAXY HOTEL"> -->
                          ...
                          <div class="col-xs-10 col-xs-offset-1 col-sm-3 col-sm-offset-0">
                            <div class="panel panel-gold text-center bg-hotel">
                              ...
                              <!-- <a href="#" target="_blank" title="Lemigo Hotel"> -->
                              <a href="<?=DN?>/register/accommodation/lemigo" target="_blank" title="Lemigo Hotel">
                                ...
                                <div class="panel-body" style="padding: 10px 5px;">
                                  ...
                                  <hr class="hr-packs-plat"> 
                                  <small class="small">Distance jusqu'au lieu de la conference: <strong>3 minutes</strong> </small><br><hr class="hr-packs-gold"> 
                      ...
                      <div class="panels">
                        <div class="row" style="margin-right: 2%">
                          ...
                          <div class="col-xs-10 col-xs-offset-1 col-sm-3 col-sm-offset-0">
                            <div class="panel panel-gold text-center bg-hotel">
                              <a href="<?=DN?>/register/accommodation/elevate" target="_blank" title="HILL TOP HOTEL">
                                ...
                                <div class="panel-body" style="padding: 10px 5px;">
                                  ...
                                  <hr class="hr-packs-plat"> 
                                  <small class="small">Distance jusqu'au lieu de la conference: <strong>8 minutes</strong> </small><br><hr class="hr-packs-gold"> 
                                  <!-- <small class="small">Distance to the venue: <strong>10 minutes</strong> </small><br><hr class="hr-packs-gold"> -->
                                  <small class="small">
                                      <ul class="htl">
                          ...
                          <div class="col-xs-10 col-xs-offset-1 col-sm-3 col-sm-offset-0">
                            <div class="panel panel-gold text-center bg-hotel">
                              ...
                              <!-- <a href="#" target="_blank" title="Hotel Villa Portofino"> -->
                              <a href="<?=DN?>/register/accommodation/portofino" target="_blank" title="Hotel Villa Portofino">
                                ...
                                <div class="panel-body" style="padding: 10px 5px;">
                                  ...
                                  <small class="small">Distance jusqu'au lieu de la conference: <strong>7 minutes</strong> </small><br><hr class="hr-packs-gold"> 
                                  <small class="small">
                                      <ul class="htl">
                          ...
                          <div class="col-xs-10 col-xs-offset-1 col-sm-3 col-sm-offset-0">
                            <div class="panel panel-gold text-center bg-hotel">
                              ...
                              <!-- <a href="#" target="_blank" title="Orient Park Hotel"> -->
                          ...
                          <div class="col-xs-10 col-xs-offset-1 col-sm-3 col-sm-offset-0">
                            <div class="panel panel-gold text-center bg-hotel">
                              <!-- <a href="https://www.tripadvisor.co.uk/Hotel_Review-g293829-d8387529-Reviews-Hotel_Hilltop_Country_Club-Kigali_Kigali_Province.html" target="_blank" title="HILL VIEW APARTMENTS"> -->
                              <!-- <a href="#" target="_blank" title="BEAUSEJOUR HOTEL"> -->
                              <a href="<?=DN?>/register/accommodation/beausejour" target="_blank" title="HILL TOP HOTEL">
                                ...
                                <div class="panel-body" style="padding: 10px 5px;">
                                  ...
                                  <hr class="hr-packs-plat"> 
                                  <small class="small">Distance jusqu'au lieu de la conference: <strong>5 minutes</strong> </small><br><hr class="hr-packs-gold"> 
                                  <!-- <small class="small">Distance to the venue: <strong>10 minutes</strong> </small><br><hr class="hr-packs-gold"> -->
                                  <small class="small">
                                      <ul class="htl">
                        ...
                        <div class="row" style="margin-right: 2%">
                          ...
                          <div class="col-xs-10 col-xs-offset-1 col-sm-3 col-sm-offset-0">
                            <div class="panel panel-gold text-center bg-hotel">
                              ...
                              <!-- <a href="#" target="_blank" title="CHEZ LANDO HOTEL"> -->
                          ...
                          <div class="col-xs-10 col-xs-offset-1 col-sm-3 col-sm-offset-0">
                            <div class="panel panel-gold text-center bg-hotel">
                              ...
                              <!-- <a href="#" target="_blank" title="Grand Legacy Hotel"> -->
                      ...
                      <h2 style="width:100%;color:#000;"><small>OTHER HOTELS</small></h2>
                      <div class="panels">
                        <div class="row" style="margin-right: 2%">
                          ...
                          <div class="col-xs-10 col-xs-offset-1 col-sm-3 col-sm-offset-0">
                            <div class="panel panel-gold text-center bg-hotel">
                              ...
                              <!-- <a href="#" target="_blank" title="Gorillas Golf Hotel"> -->
                          ...
                          <div class="col-xs-10 col-xs-offset-1 col-sm-3 col-sm-offset-0">
                            <div class="panel panel-gold text-center bg-hotel">
                              ...
                              <!-- <a href="#" target="_blank" title="LEGEND HOTEL KIGALI"> -->
                          ...
                          <div class="col-xs-10 col-xs-offset-1 col-sm-3 col-sm-offset-0">
                            <div class="panel panel-gold text-center bg-hotel">
                              ...
                              <!-- <a href="#" target="_blank" title="T2000 HOTEL KIGALI"> -->
                          ...
                          <div class="col-xs-10 col-xs-offset-1 col-sm-3 col-sm-offset-0">
                            <div class="panel panel-gold text-center bg-hotel">
                              ...
                              <!-- <a href="#" target="_blank" title="THE MIRROR HOTEL"> -->
                              <a href="<?=DN?>/register/accommodation/mirror" target="_blank" title="THE MIRROR HOTEL">
                                ...
                                <div class="panel-body" style="padding: 10px 5px;">
                                  ...
                                  <hr class="hr-packs-plat"> 
                                  <small class="small">Distance jusqu'au lieu de la conference: <strong>6 minutes</strong> </small><br><hr class="hr-packs-gold"> 
                        ...
                        <div class="row" style="margin-right: 2%">
                          ...
                          <div class="col-xs-10 col-xs-offset-1 col-sm-3 col-sm-offset-0">
                            <div class="panel panel-gold text-center bg-hotel">
                              ...
                              <!-- <a href="#" target="_blank" title="Karisimbi Hotel"> -->
                          ...
                          <div class="col-xs-10 col-xs-offset-1 col-sm-3 col-sm-offset-0">
                            <div class="panel panel-gold text-center bg-hotel">
                              ...
                              <!-- <a href="#" target="_blank" title="GORILLAS CITY CENTRE"> -->
                              <a href="<?=DN?>/register/accommodation/gorillas" target="_blank" title="GORILLAS CITY CENTRE">
                                ...
                                <div class="panel-body" style="padding: 10px 5px;">
                                  ...
                                  <hr class="hr-packs-plat"> 
                                  <small class="small">Distance jusqu'au lieu de la conference: <strong>12 minutes</strong> </small><br><hr class="hr-packs-gold"> 
                          ...
                          <div class="col-xs-10 col-xs-offset-1 col-sm-3 col-sm-offset-0">
                            <div class="panel panel-gold text-center bg-hotel">
                              ...
                              <!-- <a href="#" target="_blank" title="GARR HOTEL KIGALI"> -->
                          ...
                          <div class="col-xs-10 col-xs-offset-1 col-sm-3 col-sm-offset-0">
                            <div class="panel panel-gold text-center bg-hotel">
                              ...
                              <!-- <a href="#" target="_blank" title="HILL TOP HOTEL"> -->
                      ...
                      <div class="panels">
                        <div class="row" style="margin-right: 2%">
                          ...
                          <?php
                            ...
                            $hotelTablee->selectQuery("SELECT * FROM `hotels` ");
                                        $i = 0;
                          ...
                          <div class="col-xs-10 col-xs-offset-1 col-sm-3 col-sm-offset-0">
                            <div class="panel panel-gold text-center bg-hotel">
                              <!-- <a href="https://www.tripadvisor.co.uk/Hotel_Review-g293829-d8387529-Reviews-Hotel_Hilltop_Country_Club-Kigali_Kigali_Province.html" target="_blank" title="HILL TOP HOTEL"> -->
                              <!-- <a href="#" target="_blank" title="HILL TOP HOTEL"> -->
                              <a href="<?=DN?>/hotel/<?=$hotel_id?>" target="_blank" title="HILL TOP HOTEL">
                                <img src="<?=DNADMIN?>/data_user/hotels/<?=$photo?>" class="img img-respnsive" style="width: 100%">
                                <div class="panel-body" style="padding: 10px 5px;">
                                    <h3 class="text-default" style="margin: -10px; padding: 0"><?=$hotel_name?></h3><br>
                                  <hr class="hr-packs-plat"> 
                                  <small class="small">Distance jusqu'au lieu de la conference: <strong><?=$distance?> minutes</strong> </small><br><hr class="hr-packs-gold"> 
                                  <!-- <small class="small">Distance to the venue: <strong>10 minutes</strong> </small><br><hr class="hr-packs-gold"> -->
                                  <small class="small">
                                      <ul class="htl">
                                          <?php // $names='hilltop'; include'views/plist.php'; ?>
                                        ...
                                        ?>
                                        <li>
                                            <span class="lr"><?=$accommodation_data->name?></span>: <span class="rl">USD <?=$accommodation_data->price?></span>
                                        </li>
                                        <?php }} ?>
                                      </ul>
                                  </small><hr class="hr-packs-gold"> 
