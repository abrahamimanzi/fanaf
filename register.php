      ...
      <section>
          ...
          <div class="grid2">
              ...
              <article class="col shadow">
                  ...
                  <h3>Delegate</h3>
                  <p><b>Early bird registration 500 USD</b><br>
                    close 31st December<br>
                    Late registration closing 5th February 600USD<br>
                    onsite registration for 700 USD<br>
                  </p>
  ...
  <?php */ ?>
        <div class="sectiongrey">
            <section>
                <div class="separator"> 
                    <div class="line"></div>
                    <h2>S'INSCRIRE / Register</h2>
                    <div class="line"></div>
                </div>
                <div class="col-sm-12 col-md-12">
                    <div class="thumbnail tile tile-medium pointer" style="display: -webkit-box;padding: 0px 15px;">
                      <!-- <a href="<?=DN?>/register/gold" >
                        <h4 class="text-left text-white h4-packs text-uppercase"> Delegate</h4>
                        <p class="text-white">Early bird registration 500 USD close 31st December <br>
                        Late registration closing 5th February 600USD onsite 
                        registration for 700 USD</p>
                        <span class="pull-right"><span class="lnr lnr-arrow-right"></span></span>
                      </a> -->
                      <div  class="col-sm-3 col-md-3" style="padding: 30px 0px;">
                        <h4 class="text-left text-white h4-packs text-uppercase">Délégué / Delegate</h4>
                      </div>
                      <div  class="col-sm-3 col-md-3" style="padding: 30px 15px;background: #32d0a7;">
                        <a href="<?=DN?>/register/exhonerated" >
                          <h4 class="text-left text-white h4-packs text-uppercase"> Exonérés / Exhonerated</h4>
                          <p class="text-white text-left">0 USD</p>
                          <!-- <span class="pull-right"><span class="lnr lnr-arrow-right"></span></span> -->
                        </a>
                      </div>
                      <div  class="col-sm-3 col-md-3" style="padding: 30px 15px;">
                        <a href="<?=DN?>/register/member" >
                        <h4 class="text-left text-white h4-packs text-uppercase"> Membres / Members</h4>
                        <p class="text-white text-left"> 540 USD</p>
                        <!-- <span class="pull-right"><span class="lnr lnr-arrow-right"></span></span> -->
                      </a>
                      </div>
                      <div  class="col-sm-3 col-md-3" style="padding: 30px 15px;background: #32d0a7;">
                        <a href="<?=DN?>/register/nonmember" >
                          <h4 class="text-left text-white h4-packs text-uppercase"> Non-Membres / Non Members</h4>
                          <p class="text-white text-left">719 USD</p>
                          <!-- <span class="pull-right"><span class="lnr lnr-arrow-right"></span></span> -->
                        </a>
                      </div>
                    </div>
                    <?php /* ?>
                    <div class="thumbnail tile tile-medium tile-teal pointer" style="display: -webkit-box;padding: 0px 15px;">
                      <!-- <a href="<?=DN?>/register/gold" >
                        <h4 class="text-left text-white h4-packs text-uppercase"> Delegate</h4>
                        <p class="text-white">Early bird registration 500 USD close 31st December <br>
                        Late registration closing 5th February 600USD onsite 
                      ...
                      <div  class="col-sm-3 col-md-3" style="padding: 30px 15px;">
                        <a href="<?=DN?>/register/gold" >
                        <h4 class="text-left text-white h4-packs text-uppercase"> Members / Member</h4>
                        <p class="text-white text-left"> 540 USD</p>
                        <!-- <span class="pull-right"><span class="lnr lnr-arrow-right"></span></span> -->
                      </a>
                      </div>
                      <div  class="col-sm-3 col-md-3" style="padding: 30px 15px;background: #32d0a7;">
                        <a href="<?=DN?>/register/exhonerated" >
                          <h4 class="text-left text-white h4-packs text-uppercase"> Non-Membres / Non Member</h4>
                          <p class="text-white text-left">719 USD</p>
                          <!-- <span class="pull-right"><span class="lnr lnr-arrow-right"></span></span> -->
                        </a>
                      </div>
                    ...
                    <div class="thumbnail tile tile-medium tile-teal pointer">
                      <a href="<?=DN?>/register/local" >
                        <h4 class="text-left text-white h4-packs text-uppercase">Participation locale / Local Participation<br> 
                          <!-- <small>Private sector, Consultants, Analysts, Academia, Civil Society </small> -->
                        </h4>
                        <p class="text-white text-left">300 USD</p>
                        <span class="pull-right"><span class="lnr lnr-arrow-right"></span></span>
                      </a>
                    </div>
                    <div class="thumbnail tile tile-medium tile-teal pointer">
                      <a href="<?=DN?>/register/speaker" >
                        <h4 class="text-left text-white h4-packs text-uppercase">Conférencier / Speaker<br> 
                          <!-- <small>Private sector, Consultants, Analysts, Academia, Civil Society </small> -->
                        </h4>
                        <span class="pull-right"><span class="lnr lnr-arrow-right"></span></span>
                      </a>
                    ...
                    <div class="thumbnail tile tile-medium tile-teal pointer">
                      <a href="<?=DN?>/register/exhibitor" >
                        <h4 class="text-left text-white h4-packs text-uppercase">EXPOSANT / Exhibitor</h4>
                        <span class="pull-right"><span class="lnr lnr-arrow-right"></span></span>
                      </a>
                    </div>
                    <div class="thumbnail tile tile-medium tile-teal pointer">
                      <a href="<?=DN?>/register/media" >
                        <h4 class="text-left text-white h4-packs text-uppercase">Médias / Media</h4>
                        <span class="pull-right"><span class="lnr lnr-arrow-right"></span></span>
                      </a>
                    </div>
                    <hr>
