            ...
            <div class="col-sm-8">
                    <div class="panel panel-reg" >
                        ...
                        <div class="reg-header" style="">
                            <h2 class="text-center reg-title" style="font-size: 20px; color: #ee2738; width: 100%">Media Pass Registration</h2>
                        </div>
                        ...
                        <?php if($form->ERRORS && (@$form->ERRORS_SCRIPT['email'][0] == 'NOTUNIQUE' || @$form->ERRORS_SCRIPT['document_number'][0] == 'NOTUNIQUE')){
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3" for="orgcategory">Catégorie de média / Media Category
                                    <span  class="req">*</span> 
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3" for="pressCard">Numéro de carte de presse / Press Card Number 
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3" for="issuingAuthority">Autorité de délivrance / Issuing Authority
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3" for="dateOfExpiry">Date d'expiration / Date Of Expiry
...
-->
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3" for="special_request">Demande spéciale (jusqu'à 500 caractères) / Special Request <small>(Up to 500 characters)</small> 
                              ...
                              <div class="col-sm-9">
                                ...
                                <div class="form-group">
                                  <label class="control-label col-sm-3" for="media_equipment">
                                      Liste des équipements à apporter / List of equipment to be brought:
                                        <span  class="req">*</span>
