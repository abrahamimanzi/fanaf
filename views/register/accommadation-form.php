            ...
            <div class="col-sm-8">
                    <div class="panel panel-reg" >
                        ...
                        <div class="reg-header" style="">
                            <h2 class="text-center reg-title" style="font-size: 18px; color: #cc0000;width: 100%;"> <?=EVENT?> HOTEL HÉBERGEMENT</h2>
                        </div>
                        ...
                        <?php if($form->ERRORS && (@$form->ERRORS_SCRIPT['email'][0] == 'NOTUNIQUE' || @$form->ERRORS_SCRIPT['document_number'][0] == 'NOTUNIQUE')){
                            ...
                            <?php }?>    
                            <label class="control-label" style="padding-top:20px">S'il vous plaît remplir le formulaire ci-dessous et nous vous contacterons sous peu.</label>
                            <label class="control-label" style="padding-top:20px"> Tout <span class="req" style="font-size: 16px;">*</span> les champs sont obligatoires</label>
                            <label class="control-label" style="padding-top:20px">Please fill in the form below and we will be in touch shortly.</label>
                                  ...
                                  <h4 class="fieldset-header">CONTACT INFORMATION <span class="req"></span> 
                                    <span class="pull-right text-uppercase text-success">
                                      ...
                                      <?php
                                        switch ($hotel) {
                                          case 'raddison':
                                            echo "Raddison Blu Hotel";
                                            $hotel = 'Raddison Blu Hotel';
                                            break;
                                          
                                          case 'serena':
                                            echo "Kigali Serena Hotel";
                                            $hotel = 'Kigali Serena Hotel';
                                            break;
                                          
                                          case 'marriot':
                                            echo "MARRIOT HOTEL KIGALI";
                                            $hotel = 'MARRIOT HOTEL KIGALI';
                                            break;
                                          
                                          case 'collines':
                                            echo "Hotel Des Mille Collines";
                                          ...
                                          default:
                                            // Room details
                                            $room_id = Input::get('passtype','get');
                                            $roomTable = new Rooms();
                                            $roomTable->selectQuery("SELECT * FROM `rooms` WHERE `ID`= $room_id");
                                            $roomApprovalNumber = $roomTable ->count();

                                            if($roomTable->count()){
                                              $i = 0;
                                              foreach($roomTable->data() as $room_data){
                                                $i++;
                            ...
                            <div class="form-group">
                              <label class="control-label col-sm-3" for="code">ID d'enregistrement / Registration ID
                                    <span class="details" style="color: #f68d29">As per your FANAF AGM Registration ID</span>
                            ...
                            <div class="form-group">
                              <div class="col-sm-12">
                                  <h4 class="fieldset-header">Détails de la réservation / Reservation details <span class="req"></span></h4>
                                 <hr class="halfLine">
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                      <input onchange="myFunction(this.value)" type="text" class="datemask form-control" name="register-checkin" id="checkin" placeholder="mm/dd/yyyy"
                                       <?php if($form->ERRORS && Input::get('register-checkin','post')){?> value="<?php echo Input::get('register-checkin','post');?>" <?php }?> data-inputmask="'alias': 'mm/dd/yyyy'" data-mask="">
                                </div>
                              <!-- <div class="col-sm-9">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                        <input onchange="myFunction(this.value)" type="text" class="datemask form-control" name="register-checkout" id="checkout" placeholder="mm/dd/yyyy"
                                         <?php if($form->ERRORS && Input::get('register-checkout','post')){?> value="<?php echo Input::get('register-checkout','post');?>" <?php }?> data-inputmask="'alias': 'mm/dd/yyyy'" data-mask="">
                                </div>
                              <!-- <div class="col-sm-9">
                                  <div class="input-group">
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3" for="rooms">Nombre de chambres / No. of rooms
                                    <span  class="req">*</span> 
                                    <span style="color: red; font-size: 12px; display: block"> <?php if($form->ERRORS){ echo @$form->ERRORS_SCRIPT['rooms'][0];}?> </span>
                                </label>
                                  <div class="col-sm-9">
                            ...
                            <!-- <div class="form-group">
                              <label class="control-label col-sm-3" for="promocode">Code promo / Promocode 
                                <span  class="req"></span>
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3" for="additional_info">Information additionnelle / Additional information <br><small>(Up to 1400 characters)</small> 
                                  <span  class="req"></span> 
...
-->
                            ...
                            <div class="form-group">
                              <div class="col-sm-12">
                                  <h4 class="fieldset-header">PAQUET / PACKAGE 
                            ...
                            <div class="form-group" >
                                <label class="control-label col-sm-3" for="location">Type de chamber / Room type 
                                <span  class="req">*</span> 
                              ...
                              <div class="col-sm-9">
                                  <div class="row">
                                      <div class="col-sm-6"> 
                                           <input type="hidden" name="register-package_type" class="form-control bordered" value="<?=$room_name?>">
                                          <span type="text" class="form-control" style="background-color: #eee;"><?=$room_name?></span>
                                      </div>
                                      <div class="col-sm-6">
                                          ...
                                          <?php } */ ?>
                                                ...
                                                <span id="totolprice" type="text" class="form-control showInternationalPrice" style="background-color: #eee;">Usd <?=$room_price;?></span>
                                                <span type="text" class="form-control showLocalPrice" style="display: none; background-color: #eee;">Rwf <?=$net_local;?> </span>
...
-->
                                  ...
                                  <div class="row">
                                      <div class="col-sm-12">
                                          <select name="register-payment_method" id="payment_method" class="form-control bordered" required="required">
                                            ...
                                            <option value="Debit/Credit Card" <?php if($form->ERRORS && Input::get('register-payment_method','post') == 'Debit/Credit Card'){ echo 'selected="selected"';}?>> Carte de débit / crédit (en ligne) / Debit/Credit Card (Online)</option>
                                            <option value="Bank-Transfer" <?php if($form->ERRORS && Input::get('register-payment_method','post') == 'Bank Transfer'){ echo 'selected="selected"';}?>> Virement bancaire ou dépôt direct / Bank Transfer or direct deposit</option>
                                               <?php }?>
                            ...
                            <div class="form-group" style="display: none;">
                                <label class="control-label col-sm-3" for="nights">Nights 
                                    <span  class="req">*</span>  
                                    <span class="details" style="color: #f68d29">As per your Passport/ID</span>
                                    <span style="color: red; font-size: 12px; display: block"> <?php if($form->ERRORS){ echo @$form->ERRORS_SCRIPT['nights'][0];}?> </span>
                                </label>
                              <div class="col-sm-9">
                                <input onchange="myNights(this.value)" type="text" class="form-control" name="register-nights" id="nights" placeholder="Nights" 
                                       <?php if($form->ERRORS && Input::get('register-nights','post')){?> value="<?php echo Input::get('register-nights','post');?>" <?php }elseif($_invitation_source){?> value="<?=@$subscateginvite_data->nights?>"<?php }?>  required="required" maxlength="30">
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                                <hr class="halfLine">
                                <label class="control-label col-sm-12" style="color: #000; font-weight: 600; font-size: 13px;">Je vous remercie. Veuillez vérifier les informations que vous avez fournies ci-dessus pour vous assurer qu'elles sont correctes. </label><br>
...
-->
                                    En cliquant sur Envoyer, vous confirmez que vous acceptez notre
                                </label>
                                <span data-toggle="modal" data-target="#tcsModal_1" style="display: inline-block;color: #2a51a3; text-decoration: underline;cursor: pointer; font-size: 14px" >Termes et conditions</span> et <br>&nbsp;&nbsp;&nbsp;
                                <span data-toggle="modal" data-target="#tcsModal_2" style="display: inline-block;color: #2a51a3; text-decoration: underline;cursor: pointer; font-size: 14px" > Politique de confidentialité</span>
...
-->
                            ...
                            <div class="form-group">
                                <br>
                                <input type="hidden" name="register-hotel" value="<?=$hotel_name?>">
                                <input type="hidden" name="register-price" value="" id="priceusd">
                                <input type="hidden" name="register-room" value="<?=$room_name?>">
                                <input type="hidden" name="register-room_id" value="<?=$room_ID?>">
...
function myFunction(val) {
    ...
    $.ajax({
        ...
        success : function(html, textStatus){
            // $("#Nights").html(html);
            // alert(html);
            document.getElementById("nights").value = (html);
            var nights = (html);
            var price = nights * <?=$room_price;?>;
            document.getElementById("totolprice").innerHTML ="Usd "+ price;
            document.getElementById("priceusd").value = price;
        },
        error : function(xht, textStatus, errorThrown){
          alert("Error : " + errorThrown);
        }
    });
    // alert("The input value has changed. The new value is: " + checkout +" "+ checkin);
}
function myNights (val) {
  // body...
  var nights = $("#nights").val();
  alert("The input value has changed. The new value is: " + nights);
}
</script>
