                    ...
                    <div class="panel panel-reg" >
                        ...
                        <?php if($form->ERRORS && (@$form->ERRORS_SCRIPT['email'][0] == 'NOTUNIQUE' || @$form->ERRORS_SCRIPT['document_number'][0] == 'NOTUNIQUE')){
                            ...
                            <label class="control-label" style="padding-top:20px">
                              Notre équipe 
                              de transport vous aidera à réserver votre voiture 
                              particulière. S'il vous plaît remplir le formulaire 
                              ci-dessous et nous vous contacterons sous peu. / 
                              Our transportion team will help you book your particular 
                              car. Please fill in the form below and we will be in touch shortly.
                            </label>
                            ...
                            <br> 
                             ...
                             <div class="form-group">
                              <div class="col-sm-12"><?php $car = Input::get('passtype','get'); ?>
                                  <h4 class="fieldset-header">INFORMATIONS DE CONTACT / CONTACT INFORMATION <span class="req"></span> 
                            ...
                            <div class="form-group">
                              <label class="control-label col-sm-3" for="code">ID d'enregistrement / Registration ID
                                    <span class="details" style="color: #f68d29">As per your FANAF2018 Registration ID</span>
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3" for="checkin">Date de ramassage / Pick-Up date
                                    <span style="color: red; font-size: 12px; display: block"> <?php if($form->ERRORS){ echo @$form->ERRORS_SCRIPT['checkin'][0];}?> </span>
                                </label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3" for="checkout">Drop-Off date
