            ...
            <div class="col-sm-8">
                    <div class="panel panel-reg" >
                        ...
                        <?php if($form->ERRORS && (@$form->ERRORS_SCRIPT['email'][0] == 'NOTUNIQUE' || @$form->ERRORS_SCRIPT['document_number'][0] == 'NOTUNIQUE')){
                            ...
                            <div class="form-group">
                              <label class="control-label col-sm-3" for="company">Entreprise / Company
                                  <span  class="req">*</span> 
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-9" style="text-align: -webkit-auto;">
                                  <div class="row">
                                      <div class="col-sm-12">
                                          <select name="register-industry[]" multiple size="4"  id="industry" class="form-control bordered">
                                          <?php
