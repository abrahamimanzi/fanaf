                      ...
                      <div class="panel panel-reg" style="background: #fff;">
                          ...
                          <?php if($_group_owner){ ?>
                                      ...
                                      <div class="form-group">
                                        <div class="col-sm-12">
                                            <br>
                                            <p class=" text-center"><span class="ro_bold"><?php echo $participant_data->firstname;?> <?php echo $participant_data->lastname;?></span>, You are one step away from completing your booking for your <span class="ro_bold"><?php echo firstUC($participant_data->pass_type);?></span> room. Please wait for your group admin to process payment.
                              ...
                              <?php if(@$_GET['test'] != 'test'){?>
                                  ...
                                  <?php }else{?>
                                      ...
                                      <div class="form-group">
                                        <div class="col-sm-12">
                                            <br>
                                            <p class=" text-center"><span class="ro_bold"><?php echo $participant_data->firstname;?> <?php echo $participant_data->lastname;?></span>, You are one step away from completing your registration for your <span class="ro_bold"><?php echo firstUC($participant_data->hotel);?></span> room. Please continue to the payment portal.
