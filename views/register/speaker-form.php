            ...
            <div class="col-sm-8">
                    <div class="panel panel-reg" >
                        ...
                        <div class="reg-header" style="">
                            <h2 class="text-center reg-title" style="font-size: 20px; color: #ee2738; width: 100%">S'INSCRIRE POUR S'ADRESSER À <?=EVENT?></h2>
                        </div>
                        ...
                        <?php if($form->ERRORS && (@$form->ERRORS_SCRIPT['email'][0] == 'NOTUNIQUE' || @$form->ERRORS_SCRIPT['document_number'][0] == 'NOTUNIQUE')){
                            ...
                            Tous les <span class="req" style="font-size: 16px;">*</span> champs sont obligatoires / 
                            All <span class="req" style="font-size: 16px;">*</span> fields are mandatory  
                            </label>
                              ...
                              <div class="col-sm-9">
                                <select name="register-title" id="title" class="form-control bordered" required="required">
                                   <option value="" <?php if($form->ERRORS && Input::get('register-title','post') == ''){ echo 'selected="selected"';}?>>[--Select--]</option>
                                    <?php
                                      $array = array("Hon.","Prof.","Dr.","Mr.","Mrs.","Ms.","Military")
                                      ?> 
                                    <?php 
