            ...
            <div class="col-sm-8">
                    <div class="panel panel-reg" >
                        ...
                        <div class="reg-header" style="">
                                <h2 class="text-center reg-title" style="font-size: 18px; color: #cc0000;width: 100%;"><?=$passtype?> Pass Registration</h2>
                        </div>
                        ...
                        <?php if($form->ERRORS && (@$form->ERRORS_SCRIPT['email'][0] == 'NOTUNIQUE' || @$form->ERRORS_SCRIPT['document_number'][0] == 'NOTUNIQUE')){
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-9">
                                <select name="register-title" id="title" class="form-control bordered" required="required">
                                    ...
                                    <?php
                                      $array = array("Hon.","Prof.","Dr.","Mr.","Mrs.","Ms.")
                                      ?> 
                                    <?php 
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-9">
                                  <select name="register-gender" id="gender" class="form-control bordered" required="required">
                                        ...
                                        <option value="Female" <?php if($form->ERRORS && Input::get('register-gender','post') == 'Female'){ echo 'selected="selected"';}?>>Femelle / Female</option>
                                        <option value="Male" <?php if($form->ERRORS && Input::get('register-gender','post') == 'Male'){ echo 'selected="selected"';}?>>Mâle / Male</option>
                                  </select>
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                            <label class="control-label col-sm-3" for="company">Nom de l'organisation / Organization Name 
                                <span  class="req">*</span> 
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3" for="orgcategory">Catégorie d\'organisation / Organization Category
                                    <span  class="req">*</span> 
                            ...
                            <div class="form-group">
                              <label class="control-label col-sm-3" for="jobtitle">Profession / Job Title
                                <span  class="req">*</span> 
...
-->
                            ...
                            <div class="form-group">
                                ...
                                <input onclick="agreeTcs('toggle')" type="checkbox" id="check" name="register-check" value="check"> 
                                    ...
                                    <span data-toggle="modal" data-target="#tcsModal_1" style="display: inline-block;color: #2a51a3; text-decoration: underline;cursor: pointer; font-size: 13px" >Termes et Conditions</span> / By clicking submit you agree to the 
                                </label>
                            ...
                            <?php }?>
                            <div class="form-group">
                                <label class="control-label col-sm-12" style="color: #000; font-weight: 600; font-size: 13px;">
                                  Je vous remercie. Veuillez vérifier les informations que 
                                  vous avez fournies ci-dessus pour vous assurer qu'elles 
                                  sont correctes. / Thank you. Kindly check over the 
                                  information you have provided above to ensure it is correct. 
                                </label><br><br>
                            </div>
