              ...
              <div class="col-sm-8">
                      <div class="panel panel-reg" style="background: #fff;">
                          <div class="reg-header">
                              ...
                              <?php }else{ ?>
                              <h2 class="text-center reg-title" style="text-transform: capitalize;font-size: 1.5em;width: 100%;color: #cc0000;">Première étape terminée, les détails de paiement sont ci-dessous <!-- Step one completed, Payment details are below --></h2>
                              <?php } ?>
                          </div>
