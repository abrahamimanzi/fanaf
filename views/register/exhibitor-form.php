            ...
            <div class="col-sm-8">
                    <div class="panel panel-reg" >
                        ...
                        <div class="reg-header" style="">
                             <h2 class="text-center reg-title" style="font-size: 20px; color: #ee2738; width: 100%">Exhibitor application form</h2>
                        </div>
                        ...
                        <?php if($form->ERRORS && (@$form->ERRORS_SCRIPT['email'][0] == 'NOTUNIQUE' || @$form->ERRORS_SCRIPT['document_number'][0] == 'NOTUNIQUE')){
                            ...
                            <label class="control-label" style="padding-top:20px"> Tous les <span class="req" style="font-size: 16px;">*</span> champs sont obligatoires / All <span class="req" style="font-size: 16px;">*</span> fields are mandatory  </label>
                            ...
                            <div class="form-group">
                              <label class="control-label col-sm-3" for="exhibition_type">Type de Stand / Booth Type
                                <span  class="req">*</span> 
                              ...
                              <div class="col-sm-9">
                                <select name="register-exhibition_type" id="exhibition_type" class="form-control bordered" required="required">
                                    ...
                                    <option value="Shell scheme booths Length.3m x Width.3m x Height 2.5 cost per exhibition booth will be 2,500 USD" <?php if($form->ERRORS && Input::get('register-exhibition_type','post') == 'Shell scheme booths Length.3m x Width.3m x Height 2.5 cost per exhibition booth will be 2,500 USD'){ echo 'selected="selected"';}?>>Shell scheme booths Length.3m x Width.3m x Height 2.5 cost per exhibition booth will be 2,500 USD</option>
                                    <option value="Custom-made booth, Please specify and provide drawing (Not later than 31st December 2017) Cost for space per square meter 50 USD" <?php if($form->ERRORS && Input::get('register-exhibition_type','post') == 'Custom-made booth, Please specify and provide drawing (Not later than 31st December 2017) Cost for space per square meter 50 USD'){ echo 'selected="selected"';}?>>Custom-made booth, Please specify and provide drawing (Not later than 31st December 2017) Cost 50 USD/square meter</option>
                                </select>
                                </div>
                            </div>
                            <div class="form-group">
                              <label class="control-label col-sm-3" for="exhibition_numbooth"> Nombre des stands / How Many Booth
                                <span  class="req">*</span> 
                            ...
                            <div class="form-group">
                              <label class="control-label col-sm-3" for="exhibition_rownum"> Option de marquage / Branding option 
                                <span  class="req">*</span> 
                                    <span class="details" style="color: #f68d29">Wall branding 3m x 2.5 wall 210 USD per wall</span>
                              ...
                              <div class="col-sm-9">
                                <select name="register-exhibition_rownum" id="exhibition_rownum" class="form-control bordered" required="required">
                                    ...
                                    <option value="Un mur / One wall - 210 USD" <?php if($form->ERRORS && Input::get('register-exhibition_rownum','post') == 'Un mur / One wall - 210 USD'){ echo 'selected="selected"';}?>>Un mur / One wall - 210 USD</option>
                                    <option value="Deux murs / Two walls - 420 USD" <?php if($form->ERRORS && Input::get('register-exhibition_rownum','post') == 'Deux murs / Two walls - 420 USD'){ echo 'selected="selected"';}?>>Deux murs / Two walls - 420 USD</option>
                                    <option value="Trois murs / Tree walls - 630 USD" <?php if($form->ERRORS && Input::get('register-exhibition_rownum','post') == 'Trois murs / Tree walls - 630 USD'){ echo 'selected="selected"';}?>>Trois murs / Tree walls - 630 USD</option>
                                </select>
                                </div>
                            </div>
                             ...
                             <div class="form-group">
                              <div class="col-sm-12">
                                  <h4 class="fieldset-header">INFORMATIONS DE CONTACT / CONTACT INFORMATION <span class="req"></span></h4>
                                 <hr class="halfLine">
                              </div>
                            </div>
                            
                            <div class="form-group">
                              <label class="control-label col-sm-3" for="title">Titre / Title
                                <span  class="req">*</span> 
                             </label>
                              <div class="col-sm-9">
                             ...
                             <div class="form-group">
                                <label class="control-label col-sm-3" for="firstname">Prénom / First Name 
                                    <span  class="req">*</span>  
                            ...
                            <div class="form-group">
                              <label class="control-label col-sm-3" for="lastname">Nom de famille / Last Name  
                                  <span  class="req">*</span> 
                                    <span class="details" style="color: #f68d29">As per your Passport/ID</span>
                            ...
                            <div class="form-group">
                              <label class="control-label col-sm-3" for="othername">Autre nom / Other Name 
                                    <span class="details" style="color: #f68d29">As per your Passport/ID</span>
                            ...
                            <div class="form-group">
                              <label class="control-label col-sm-3" for="tel2">Téléphone de bureau / Office  telephone </label>
                              <div class="col-sm-9">
                                  <div class="row">
                                      <div class="col-sm-6">
                            ...
                            <div class="form-group">
                              <label class="control-label col-sm-3" for="confirm_email">Confirmez votre e-mail / Confirm Email
                                <span  class="req">*</span> 
                            ...
                            <div class="form-group">
                              <label class="control-label col-sm-3" for="gender">Genre / Gender
                                <span  class="req">*</span> 
                            ...
                            <div class="form-group">
                              <div class="col-sm-12">
                                  <h4 class="fieldset-header">ORGANISATION / ORGANIZATION <span class="req"></span></h4>
                                 <hr class="halfLine">
                              </div>
                            </div>
                             
                            <div class="form-group">
                              <label class="control-label col-sm-3" for="company"><?php if($categ=="Media"){ echo 'Media House';}else{ echo 'Nom de l\'organisation / Organization Name';}?> 
                                  <span  class="req">*</span> 
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3" for="orgcategory"><?php if($categ=="Media"){ echo 'Media Category ';}else{ echo 'Catégorie d\'organisation / Organization Category ';}?> 
                                    <span  class="req">*</span> 
                                        ...
                                        <div class="col-sm-6">
                                            <select name="register-orgcategory" id="orgcategory" class="form-control bordered" onchange="Checkother1(this,'#orgcategory1');" required="required">
                                                ...
                                                <option value="" <?php if($form->ERRORS && Input::get('register-orgcategory','post') == ''){ echo 'selected="selected"';}?>> [--Select--] </option>
                                                    ...
                                                    <option value="Civil Society" <?php if($form->ERRORS && Input::get('register-orgcategory','post') == 'Civil Society'){ echo 'selected="selected"';}?>>Société civile / Civil Society </option>


                                                    <option value="International Organization" <?php if($form->ERRORS && Input::get('register-orgcategory','post') == 'International Organization'){ echo 'selected="selected"';}?>>Organisation internationale / International Organization</option>

                                                    <option value="Non-Governmental Organization" <?php if($form->ERRORS && Input::get('register-orgcategory','post') == 'Non-Governmental Organization'){ echo 'selected="selected"';}?>>Organisation non gouvernementale / Non-Governmental Organization</option>

                                                    <option value="Non-Profit Organization" <?php if($form->ERRORS && Input::get('register-orgcategory','post') == 'Non-Profit Organization'){ echo 'selected="selected"';}?>>Organisation à but non lucratif / Non-Profit Organization</option>

                                                    <option value="Private/Corporation" <?php if($form->ERRORS && Input::get('register-orgcategory','post') == 'Private/Corporation'){ echo 'selected="selected"';}?>>Privé / Société / Private/Corporation</option>

                                                    <option value="Regional Organization" <?php if($form->ERRORS && Input::get('register-orgcategory','post') == 'Regional Organization'){ echo 'selected="selected"';}?>>Organisation régionale / Regional Organization</option>
                                                
                                                <option value="Other" <?php if($form->ERRORS && Input::get('register-orgcategory','post') == 'Other'){ echo 'selected="selected"';}?>>Autre / Other</option>
                                            </select>
                                        </div>
                                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                              <label class="control-label col-sm-3" for="jobtitle"><?php if($categ=="Media"){ echo 'Position';}else{ echo 'Profession / Job Title';}?>
                                <span  class="req">*</span> 
                            ...
                            <div class="form-group">
                              <label class="control-label col-sm-3" for="industry">Industrie / Industry
                                <span  class="req">*</span> 
                                  ...
                                  <div class="row">
                                      <div class="col-sm-6">
                                          <select name="register-industry" id="industry" class="form-control bordered" onchange="Checkother1(this,'#industry1');" required="required">
                                                ...
                                                <option value="Assurance / Insurance" <?php if($form->ERRORS && Input::get('register-industry','post') == 'Assurance / Insurance'){ echo 'selected="selected"';}?>>Assurance / Insurance</option>

                                                <option value="Academia & Recherche / Academia & Research" <?php if($form->ERRORS && Input::get('register-industry','post') == 'Academia & Recherche / Academia & Research'){ echo 'selected="selected"';}?>>Academia & Recherche / Academia & Research</option>

                                                <option value="Institution publique / Public Institution" <?php if($form->ERRORS && Input::get('register-industry','post') == 'Institution publique / Public Institution'){ echo 'selected="selected"';}?>>Institution publique / Public Institution</option>

                                                <option value="Institution privée / Private Institution" <?php if($form->ERRORS && Input::get('register-industry','post') == 'Institution privée / Private Institution'){ echo 'selected="selected"';}?>>Institution privée / Private Institution</option>
                            ...
                            <div class="form-group">
                              <label class="control-label col-sm-3" for="orgaddress">Adresse physique / Physical Address:
                                    <span  class="req">*</span> 
                            ...
                            <div class="form-group">
                              <label class="control-label col-sm-3" for="website">Site Internet / Website:</label>
                              <div class="col-sm-9">
                            ...
                            <div class="form-group">
                              <label class="control-label col-sm-3" for="residence-country" style="padding-right: 5px">Pays de résidence / Country of Residence
                                <span  class="req">*</span>  
                            ...
                            <div class="form-group">
                              <label class="control-label col-sm-3" for="citizenship-country">Citoyenneté / Citizenship
                                <span  class="req">*</span> 
                            ...
                            <div class="form-group">
                              <label class="control-label col-sm-3" for="document_type"  style="padding-right: 5px">Type de document d'identité / Type of ID document
                                <span  class="req">*</span> 
                                  ...
                                  <div class="row">
                                      <div class="col-sm-6">
                                          <select name="register-document_type" id="document_type" class="form-control bordered" required="required">
                                              ...
                                              <option value="Passport" <?php if($form->ERRORS && Input::get('register-document_type','post') == 'Passport'){ echo 'selected="selected"';}?>>Passeport / Passport</option>
                                            
                                              <option class="idcard" value="ID card" id="notrwanda" <?php if($form->ERRORS && Input::get('register-document_type','post') == 'ID card'){ echo 'selected="selected"';}?>>Carte d'identité / ID card</option>
...
-->
                            ...
                            <div class="form-group" >
                                <label class="control-label col-sm-3" for="location">Type de passe / Pass type 
                                <span  class="req">*</span> 
                            ...
                            <div class="form-group" >
                                <label class="control-label col-sm-3" for="payment_method">Mode de paiement / Payment Method 
                                <span  class="req">*</span> 
                                  ...
                                  <div class="row">
                                      <div class="col-sm-12">
                                          <select name="register-payment_method" id="payment_method" class="form-control bordered" required="required">
                                            ...
                                            <option value="Group owner" <?php if($form->ERRORS && Input::get('register-payment_method','post') == 'Group owner'){ echo 'selected="selected"';}?>>Vous recevrez une facture cumulée / You will receive a cumulated Invoice</option>
                            ...
                            <div class="form-group">
                              <div class="col-sm-12">
                                  <h4 class="fieldset-header">Flight Details <span class="req"></span></h4>
                                 <hr class="halfLine">
                              </div>
                            </div>

                            <div class="form-group">
                                <label class="control-label col-sm-3" for="checkin">Date d'arrivée / Check-in date
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3" for="checkinhour">Heure d'Arrive / Check-in hour
                                    <span style="color: red; font-size: 12px; display: block"> <?php if($form->ERRORS){ echo @$form->ERRORS_SCRIPT['checkinhour'][0];}?> </span>
                                </label>
                                <div class="col-sm-9">
                                      <!-- <input type="text" class="datemask form-control" name="register-checkin" id="checkin" placeholder="dd/mm/yyyy"
                                       <?php if($form->ERRORS && Input::get('register-checkinhour','post')){?> value="<?php echo Input::get('register-checkinhour','post');?>" <?php }?> data-inputmask="'alias': 'dd/mm/yyyy'" data-mask=""> -->
                                      <input class="form-control data-mask" name="register-checkinhour" type="text" <?php if($form->ERRORS && Input::get('register-checkinhour','post')){?>value="<?php echo Input::get('register-checkinhour','post');?>" <?php }?> data-mask="__-__" placeholder="hh-mm"/>
                                </div>
                              <!-- <div class="col-sm-9">
                                  <div class="input-group">
                                      <label class="input-group-addon" for="checkin">
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3" for="checkout">Date de départ / Check-out date
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3" for="checkouthour">Heure de Depart / Departure hour
                                    <span style="color: red; font-size: 12px; display: block"> <?php if($form->ERRORS){ echo @$form->ERRORS_SCRIPT['checkouthour'][0];}?> </span>
                                </label>
                                <div class="col-sm-9">
                                      <!-- <input type="text" class="datemask form-control" name="register-checkin" id="checkin" placeholder="dd/mm/yyyy"
                                       <?php if($form->ERRORS && Input::get('register-checkinhour','post')){?> value="<?php echo Input::get('register-checkinhour','post');?>" <?php }?> data-inputmask="'alias': 'dd/mm/yyyy'" data-mask=""> -->
                                      <input class="form-control data-mask" name="register-checkouthour" type="text" <?php if($form->ERRORS && Input::get('register-checkouthour','post')){?>value="<?php echo Input::get('register-checkouthour','post');?>" <?php }?> data-mask="__-__" placeholder="hh-mm"/>
                                </div>
                              <!-- <div class="col-sm-9">
                                  <div class="input-group">
                                      <label class="input-group-addon" for="checkin">
                            ...
                            <script>
                              ...
                              // Array.prototype.forEach.call(document.body.querySelectorAll("*[data-mask]"), applyDataMask);
                              Array.prototype.forEach.call(document.getElementsByClassName("data-mask"), applyDataMask);
