...
<body class="home page page-id-2" id="up">
  ...
  <div class="sectiongrey">
      <section>
        <div class="separator"> 
          <div class="line"></div>
          <h2>Présentation de la FANAF</h2>
          <div class="line"></div>
        </div>
          <div class="grid3">
          <p>
              La Fédération des Sociétés d'Assurances de Droit 
              National Africaines plus connue sous le sigle "FANAF" 
              a été créée le 17 mars 1976 à  Yamoussoukro 
              (République de Côte d'Ivoire). Association professionnelle 
              dont le siège social est à  Dakar au Sénégal, la FANAF 
              réunit (à  la date du 31 décembre 2016) 196 Sociétés Membres dont : 

              </p>  


              <p>
                47 Sociétés Vie ; 125 Sociétés Non Vie ; 19 Sociétés de 
                Réassurances et 4 Fonds de Garantie Automobile (FGA) ; 1 
                Société Crédit / Caution opérant dans les pays (29) suivants :
              </p>

              <p>
                Afrique du Sud, Algérie, Bahrain, Bénin, Burkina Faso, Burundi, 
                Cameroun, Centrafrique, Congo Brazzaville, Côte d’Ivoire, Gabon, 
                Ghana, Guinée Conakry, Guinée Equatoriale, Kenya, Madagascar, 
                Mali, Maroc, Mauritanie, Niger, Nigéria, République Démocratique du Congo, 
                Rwanda, Sénégal, Sierra Léone, Tanzanie, Tchad, Togo, Tunisie
              </p>
              <!-- <p>
  ...
  <div class="sectiongreen-2">
      <section>
        <div class="separator"> 
          ...
          <div class=" shadow grid2 programme" id="form">
              <article class="col shadow" style="width: 25%;margin:0;">
                  ...
                  <ul>
                    ...
                    <hr>
                    <li>10 h – 10 h 30<br>
                      Pause café offert par la SCG -RE
                    </li>
                    <hr>
                    <li>10 h 30 – 11 h 30<br>
                      Conférence inaugurale<br>

                      Invité d’honneur : M. Thierry TANOH :<br>
                      Directeur Général Groupe Ecobank
                    </li>
                    <hr>
                    <li>11 h 45 – 13 h<br>
                      Assemblée générale de la FANAF (présentation et 
                      adoption du rapport d’activités – présentation et 
                      adoption des comptes de l’année 2013)
                    </li>
                    <hr>
                    <li>13 h<br>
                      Déjeuner offert par la CICA-RE
                    </li>
                    <hr>
                    <li>15 h – 18 h<br>
                      Table ronde CIMA - FANAF
                    </li>
                    <hr>
                    <li>19 h<br>
                      Cocktail offert par le Réseau Globus
                    </li>
              ...
              <article class="col shadow" style="width: 25%;margin:0;">
                  ...
                  <ul>
                    <li>9 h – 10 h<br>
                      Le Cloud Computing dans le secteur de l’assurance 
                      Président de séance : M. René BUCAIONI : 
                      Membre du Bureau Exécutif de la FANAF 
                      Intervenant : M. Abdelmajid BEZZAZ 
                      Membre du Directoire Eurafric Information 
                      (Filiale informatique de RMA Watanya, BMCE Bank 
                      et le groupe français ACM-CM-CIC), Maroc 
                      Directeur de Projets
                    </li>
                    <hr>
                    <li>10 h – 11 h<br>
                      Les nouveaux enjeux du contrôle des compagnies d’assurances
                      Président de séance : M. Jean Claude NGBWA :
                      Secrétaire Général de la CIMA
                      Intervenant : M. François TEMPE :
                      Coordinateur IAIS pour la « région francophone »
                      ACP (Autorité de contrôle prudentiel) –
                      Service Affaires Internationales Assurance, France.
                    </li>
                    <hr>
                    <li>11 h – 11 h 30<br>
                      Pause café
                    ...
                    <hr>
                    <li>11 h 30 – 12 h 30<br>
                      L’actuariat et les nouveaux horizons de l’assurance vie en Afrique
                      Président de séance : M. Mamadou FAYE :
                      Administrateur Directeur Général de la Sénégalaise de
                      l’Assurance Vie, Sénégal
                      Intervenant : M. AYMRIC KAMEGA,
                      Directeur Associé PRIM'ACT, France
                    </li>
                    <hr>
                    <li>12 h 30 – 13 h 30<br>
                      De l’assurantiel à l’assistanciel

                      Président de séance : M. Alain HOUNGUE :
                      Membre du Bureau Exécutif de la FANAF
                      Intervenant : M. Philippe BELLARD,
                      Président Directeur Général des Groupes Austral -
                      Antilles – Atoll Assistance, France
                    </li>
                    <hr>
                    <li>13 h 30<br>
                      Déjeuner offert par AVENI-RE
                    </li>
                    <hr>
                    <li>15 h – 17 h<br>
                      Forum FANAF – FIAC
                    ...
                    <hr>
                    <li>19 h<br>
                      Cocktail offert par le Groupe Allianz
                    </li>
                    <hr style="margin-bottom: 0;margin-top: 4px;">
              ...
              <article class="col shadow" style="width: 25%;margin:0;">
                  ...
                  <ul>
                    <li>9 h – 10 h<br>
                      ...
                      Président de séance : M. Laban KOFFI :
                      Président du Comité des Compagnies d’Assurances Mali
                      Intervenant : Monsieur Saliou BAKAYOKO,
                      Directeur Général de LMAI VIE, Côte d’Ivoire
                    </li>
                    <hr>
                    <li>10 h – 11 h<br>
                      Les placements des compagnies d’assurances
                      Président de séance : M. André BAYALA :
                      Président de l’APSAB, Burkina Faso
                      Intervenants :
                      CIMA
                      M. AMENOUVE EDOH :
                      Directeur Général de la BRVM, Côte d’Ivoire
                      M. Christian AGOSSA :
                      Directeur Général de la CRRH-UEMOA, Togo
                    </li>
                    <hr>
                    <li>11 h – 11 h 30<br>
                      Pause café
                    ...
                    <hr>
                    <li>11 h 30 – 12 h 30<br>
                      La gestion externalisée des contrats et sinistres dans

                      l’industrie de l’assurance
                      Président de séance : Madame Eugénie DENDE :
                      Membre du Bureau Exécutif de la FANAF
                      Intervenant : Monsieur Max de Front-REAULX :
                      Directeur Général, Théorème Paris, France
                    </li>
                    <hr>
                    <li>12 h 30 – 13 h 30<br>
                      L’Intelligence Economique

                      Président de séance : M. LOCOH Kodjo :
                      Directeur Général de l’Union des Assurances du Togo
                      (UAT IARD), Togo
                      Intervenant : M. Lucien Junior NTAMAG :
                      Consultant Sénior-Directeur Exécutif du Cabinet
                      Cirie-Conseil, Cameroun
                    </li>
                    <hr>
                    <li>13 h 30<br>
                      Déjeuner offert par l’APSAB
                    </li>
                    <hr>
                    <li>15 h – 16 h<br>
                      AG FANAF
                    ...
                    <hr>
                    <li>Après midi libre<br>
                    </li>
                    <hr>
                    <li>19 h<br>
                      Dîner offert par les Filiales Africaines du Groupe AXA
                    </li>
                    <hr style="margin-bottom: 0;margin-top: 4px;">
              ...
              <article class="col shadow" style="width: 25%;margin:0;">
                  ...
                  <ul>
                    <li>9 h – 10 h<br>
                      <b>Ateliers :</b>
                      Atelier n° 1 : Sur les Nouveaux Métiers
                      Président : M. René BUCAIONI :
                      Membre du Bureau Exécutif de la FANAF
                      Atelier n° 2 : Sur les Placements et Fonds de pension
                      Président : M. Adama NDIAYE :
                      Membre du Bureau Exécutif de la FANAF
                    </li>
                    <hr>
                    <li>10 h – 11 h<br>
                    ...
                    <hr>
                    <li>11 h 30 – 13 h 30<br>
                      Suite de l’assemblée générale :<br>
                      - Adoption du budget 2014
                      - Election des Membres du Bureau Exécutif
                    </li>
                    <hr>
                    <li>13 h 30 – 14 h 30<br>
                      Déjeuner offert par ?
                    </li>
                    <hr>
                    <li>17 h – 18 h:<br>
                    ...
                    <hr>
                    <li>20 h<br>
                      Dîner de gala offert par l’APSAB
                    </li>
      ...
      <section>
          ...
          <div class="grid2">
              <article class="col shadow">
                  ...
                  Aliquam tincidunt erat at aliquet pellentesque. 
                  Ut euismod leo enim, vitae sollicitudin diam dapibus eget. 
                  Maecenas aliquam suscipit augue, eu rhoncus ante dapibus at. 
                  Interdum et malesuada fames ac ante ipsum primis in faucibus. 
                  Suspendisse potenti. Integer nec pellentesque tellus. 
                  Pellentesque auctor non erat gravida posuere. 
                  Aenean accumsan ac ipsum eget malesuada. 
                  Proin nec felis in ante volutpat dictum. 
                  Maecenas ullamcorper rutrum tristique. 
                  Duis tempor nisl mauris, vitae tincidunt ex tristique vitae. 
                  Aenean quis tincidunt tellus, et vestibulum ipsum. 
                  Integer mattis fringilla massa, eget rutrum felis cursus eu.
                  </p>
              </article>
              <article class="col shadow">
                  <!-- <figure><img src="img/Green-03.jpg" alt="free-admin-template-psd"></figure><br> -->
                  <h3>Exhibitors</h3>
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. 
                  Aliquam tincidunt erat at aliquet pellentesque. Ut euismod leo enim, 
                  vitae sollicitudin diam dapibus eget. Maecenas aliquam suscipit augue, 
                  eu rhoncus ante dapibus at. Interdum et malesuada fames ac ante ipsum 
                  primis in faucibus. Suspendisse potenti. Integer nec pellentesque tellus. 
                  Pellentesque auctor non erat gravida posuere. Aenean accumsan ac ipsum 
                  eget malesuada. Proin nec felis in ante volutpat dictum. Maecenas 
                  ullamcorper rutrum tristique. Duis tempor nisl mauris, vitae tincidunt 
                  ex tristique vitae. Aenean quis tincidunt tellus, et vestibulum ipsum. 
                  Integer mattis fringilla massa, eget rutrum felis cursus eu.</p>
              </article>
              <!-- <article class="col shadow">
      ...
      <section>
          ...
          <div class="grid3">
              ...
              <p class="ideas-det" style="padding-top: 20px;">
                Kigali Convention Centre will be serving as the venue of FANAF AGM 2017. <br>
    ...
    <section>
      ...
      <div class="contact-form shadow" id="form">
        <div id="location">
                ...
                <h1><a name="Head_Office"></a></h1>
                <p>Address: 3rd Floor, RSSB Tower II, Kigali, Rwanda <br />P.o.Box: **** Kigali Rwanda<br />T: +250 78******* <br />E: <a href="mailto:info@fanaf.org">info@fanaf.org </a></p>
            </div>
